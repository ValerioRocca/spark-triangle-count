...
if __name__ == '__main__':
    ...
    if F==0:
        ...
        print(f"- Number of triangles (median over {R} runs)= {np.median(t_final_values)}")
        print(f"- Running time (average over {R} runs) = {(end_time - start_time)/R*1000} ms")
